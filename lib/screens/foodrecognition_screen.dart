...
//             // Validate path inside isolate
//             if (imagePath.isEmpty) {
//               return "ERROR: Empty image path";
//             }

//             // Create a new File object inside the isolate
//             final File imageFile = File(imagePath);

//             // Check if file exists inside isolate
//             if (!await imageFile.exists()) {
//               return "ERROR: Image file not found";
//             }

//             return await GeminiService.analyzeImageFromFile(
//               imageFile,
...
//           }
//         }, {'imagePath': image.path, 'prompt': prompt});
